...
import { getOneBook } from '../../server/allAPI';
const Viewbook = () => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
          ...
          <div className="md:col-span-2 lg:col-span-3 rounded-[0.75rem] bg-[#242424] p-6 lg:p-8">
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              <span className={`text-white text-xs font-semibold px-3 py-1 rounded-full  ${book.status == "active" ? "bg-[#008000]" : "bg-[#FF0000]"}`}>
                 {book.status == "active" ? "Available": "Not Available"}
              </span>
